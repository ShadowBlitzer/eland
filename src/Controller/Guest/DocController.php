...
class DocController extends AbstractController
{
		...
		Request $request, string $schema, string $access):Response
	{
		...
		$docs = $docRepository->getAll($schema, $access);
		...
		Request $request, string $schema, string $access, string $mapId):Response
	{
		...
		$docs = $docRepository->getAll($schema, $access, $mapId);

		return $this->render('doc/' . $access . '_map.html.twig', [
			'map_name'	=> $mapName,
			'map_id'	=> $mapId,
			'docs'		=> $docs,
		]);
		...
		Request $request, string $schema, string $access, string $mapId):Response
	{
		...
		return $this->render('doc/' . $access . '_map_edit.html.twig', [
